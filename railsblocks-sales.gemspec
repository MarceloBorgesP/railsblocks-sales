...
require "railsblocks/sales/version"

# Describe your gem and declare its dependencies:
Gem::Specification.new do |s|
  s.name        = "railsblocks-sales"
  s.version     = Railsblocks::Sales::VERSION
  s.authors     = ["Celso Fernandes"]
  s.email       = ["fernandes@zertico.com"]
  s.homepage    = "http://domain.com"
  s.summary     = "Summary of Railsblocks::Sales."
  s.description = "Description of Railsblocks::Sales."
  s.license     = "MIT"
